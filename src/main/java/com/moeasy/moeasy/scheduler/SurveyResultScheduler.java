...
import com.moeasy.moeasy.scheduler.dto.*;
...
public class SurveyResultScheduler {
    ...
    public void logSurveyResultsUpdatedInLast10Min() {
        ...
        try {
            for (Survey survey : updated) {
                ...
                String summarizedJsonWithoutDemo = SurveyUtils.excludeAgeAndGender(summarizedJson, objectMapper);
    ...
    private ContentDto getContentData(String summarizedJson, ObjectMapper objectMapper) throws IOException {
    ...
    private SentencesListDto getSentencesData(String summarizedJson, Integer totalCount, ObjectMapper objectMapper) throws IOException {
    ...
    private List<String> getKeywordsData(String summarizedJson, ObjectMapper objectMapper) throws IOException {
