...
public class QuestionService {
    public List<Map<String, List<String>>> makeMultipleChoiceQuestions() {
        List<Map<String, List<String>>> questions = new ArrayList<>();
        for (int i=0; i<8; i++) {
            questions.add(makeMultipleChoiceQuestion());
        }
        return questions;
    }

    public Map<String, List<String>> makeMultipleChoiceQuestion() {
    ...
    public List<Map<String, List<String>>> makeShortAnswerQuestions() {
        List<Map<String, List<String>>> questions = new ArrayList<>();
        for (int i=0; i<2; i++) {
    ...
    public Map<String, List<String>> makeShortAnswerQuestion() {
        Map<String, List<String>> question = new HashMap<>();
        question.put(
    ...
    public Map<String, List<String>> makeShortAnswerQuestion2() {
        Map<String, List<String>> question = new HashMap<>();
        question.put(
